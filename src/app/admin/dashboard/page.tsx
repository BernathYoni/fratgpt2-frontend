...
export default function AdminDashboard() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr] gap-8">
      {/* SIDEBAR */}
      <div className="flex flex-col gap-6 sticky top-20 sm:top-24 lg:top-32 h-[calc(100vh-5rem)] sm:h-[calc(100vh-6rem)] lg:h-[calc(100vh-8rem)] overflow-y-auto pb-4 self-start">
        {/* Sidebar Header */}
